# -*- coding: utf-8 -*-
"""This code is inproved based on VGG19 model for Keras.
...
def VGG19(include_top=True, weights='imagenet',
    ...
    # Block 1
    x = Convolution2D(3, 1, 1, activation=center_normalize, border_mode='same', name='block1_conv0',init='he_normal')(img_input)
    ...
    if include_top:
        ...
        #x = Dense(4096, activation='relu', name='fc0',init='he_normal')(x)
        x = Dense(4096, activation='relu', name='fc1')(x)
        #x = Convolution1D(4096,1,1,activation='relu', name='fc1')(x)
        ...
        if K.image_dim_ordering() == 'th':
            ...
            if include_top:
                ...
                weights_path = get_file('vgg19_weights_th_dim_ordering_th_kernels_notop.h5',
                                        ...
                                        cache_subdir='models')
            '''
            model.load_weights('vgg19_weights_th_dim_ordering_th_kernels.h5',by_name=True)
