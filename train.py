...
from model import get_model_ALL_ED
...
def load_train_data():
    ...
    """
    X = np.load('data/X_train_ED_ALL.npy')
...
def train():
    ...
    #X_train2, y_train2, X_test2, y_test2 = split_data(X_train, y_train, split_ratio=0.5)
    #loss=0
    nb_iter = 150
    epochs_per_iter = 1
    batch_size = 64
    ...
    for i in range(nb_iter):
        ...
        #loss=loss_diastole+val_loss_diastole
